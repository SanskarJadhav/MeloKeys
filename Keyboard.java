...
public class Keyboard {
    ...
    public Keyboard(String username) throws UnsupportedAudioFileException, LineUnavailableException, IOException {
        this("zsxdcvgbhnjm,l.;/q2w3e4rt6y7ui9o0p-[", "C", username);
    }

    // for any customisation
    private Keyboard(String keyboardString, String firstWhiteKey, String username) throws UnsupportedAudioFileException, LineUnavailableException, IOException {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            frame = new JFrame("3 Octave Keyboard");
            frame.setMinimumSize(new Dimension(initialWidth, initialHeight +200));
            frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
            ImageIcon img = new ImageIcon("musiclogo.png");
            frame.setIconImage(img.getImage());
            
            jButton2 = new javax.swing.JButton();
            jButton2.setFont(new java.awt.Font("Monotype Corsiva",3,18));
            ...
            panel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, -1, -1));
    ...
    private class TextBox extends javax.swing.JPanel {
    /**
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 3, true), "MeloKeys", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Monotype Corsiva", 3, 36), new java.awt.Color(255, 255, 255))); // NOI18N
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setEnabled(false);
        setPreferredSize(new java.awt.Dimension(1155, 200));
        ...
        jComboBox1.setFont(new java.awt.Font("Monotype Corsiva", 3, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Fur Elise", "Arabian Nights (Aladdin)", "See You Again (Fast and Furious 7)", "Despacito", "Tum Hi Ho", "Gurenge - Demon Slayer"}));
        jComboBox1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jComboBox1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, -1, -1));

        jLabel2.setFont(new java.awt.Font("Monotype Corsiva", 3, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Notes");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 50, -1, -1));
        
        jButton1.setFont(new java.awt.Font("Monotype Corsiva",3,18));
        ...
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        ResultSet rs = st.executeQuery("select song from songs where name = '" + x + "';");
        String p2 = "";
        while(rs.next()) {
            p2 = rs.getString(1);
        }
        ...
        jTextArea1.setText(p2);
        jTextArea1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)); jTextArea1.setFocusable(false);
        jTextArea1.setRequestFocusEnabled(false);
        jScrollPane1.setViewportView(jTextArea1);
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 86, 460, 90));
    ...
    public static void main(String[] args) {
        try {
            Keyboard keyboard = new Keyboard(username);
